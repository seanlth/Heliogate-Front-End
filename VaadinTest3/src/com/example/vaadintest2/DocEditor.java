...
public class DocEditor extends CustomComponent {
	...
	private boolean SelectedModalityOnce = false;
	...
	private void applyMainLayoutHooks() {
		...
		simpleUserButton.addListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				// have you picked a modality before?
				if (SelectedModalityOnce == true){
					
					
					if(isSimple == false && IsTheUserSure() == true){
						reinitialize();
...
//						}
	...
	private boolean IsTheUserSure(){
		boolean returnvalue = false;
		ModalityAreYouSureWindow AreYouSureWindow = new ModalityAreYouSureWindow();
		getWindow().addWindow(AreYouSureWindow);

		while(AreYouSureWindow.done == false){
			
		}
		
		if (AreYouSureWindow.getanswer() == true){
			returnvalue = true;
		//	System.out.println("returned true from IsTheUserSure");
		}else{
			returnvalue = false;
		//	System.out.println("returned False from IsTheUserSure");
			
		}
		
		AreYouSureWindow.exit();
		//AreYouSureWindow.exit();
...
class ModalityAreYouSureWindow extends Window {
    ...
    public ModalityAreYouSureWindow() {
        
    	super("Change of user modality...");
    	setModal(false);
    	setHeight("200px");
    	setWidth("200px");
    	center();
    	...
    	content.addComponent(new Label("Doing this will reset you to the beginning. Are you sure?"));
