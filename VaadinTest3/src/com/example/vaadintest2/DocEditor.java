...
public class DocEditor extends CustomComponent {
	boolean DEBUGGINGMODE = true; 
        ...
        public DocEditor() {
               ...
               // cataloguesComboBox.setNullSelectionAllowed(true);  
...
//              }
                                ...
                                if(DEBUGGINGMODE == false){
                                   ...
                                   parametersData = parser.getEventArray();                               
                                	...
                                	// parameters[5] = "test5";
                                     ...
                                     parametersData = new String[5][5];
                                     parametersData[0][0] = "0";
                                     parametersData[0][1] = "1";
                                     parametersData[0][2] = "2";
                                     parametersData[0][3] = "3";
                                     parametersData[0][4] = "4";
                                     //parametersData[1][1] = "3";
                ...
                setParametersButton.addListener(new Button.ClickListener() {
                        public void buttonClick(ClickEvent event) {
                                if(parameterFields == null){
                                	System.out.println("parameterFields is null");
 ...
 //here
                                ...
                                table.setColumnWidth(table, 100);
                             //   middle_tom_area.addComponent(table, "top:19.0px;left:260.0px;");
                                
                                for (int i = 0; i < parameters.length; i++) {
                                	table.addContainerProperty(parameters[i], String.class,  null);
                                }
                         
                                for (int i=0; i< parametersData.length; i++){
                                	Object[] row = new Object[parametersData.length]; 
                                	for(int j =0; j< parameters.length; j++){
                                	    if (parametersData[i][j] == null){
                                	    	row[j] = "null";
                                	    }else{
                                	    	row[j] = parametersData[i][j];	
                                	    }
                                	}
                                	
                                	
                                	table.addItem(row, new Integer(i));
                                } 
                                middle_tom_area.addComponent(table, "top:" + yPosition + "px;left:"+ xPosition  +"px");
...
//              widthStepField.setEnabled(true);
        ...
        private AbsoluteLayout buildTop_sean_area() {
                ...
                APMReadyTest
                                .setCaption("KEVINTest if the Advanced Propagation Model is ready to run");
