...
public class DocEditor extends CustomComponent {
	...
	private AbsoluteLayout buildMiddle_tom_area() {
		...
		middle_tom_area.addComponent(maxLongitudeField, "top:164.0px;left:344.0px;");
		...
		middle_tom_area
				.addComponent(longitudeStepField, "top:164.0px;left:483.0px;");
		...
		middle_tom_area.addComponent(minLongitudeField, "top:164.0px;left:204.0px;");
		...
		middle_tom_area.addComponent(minWidthField, "top:210.0px;left:204.0px;");
		...
		middle_tom_area.addComponent(maxWidthField, "top:210.0px;left:344.0px;");
		...
		middle_tom_area.addComponent(widthStepField, "top:210.0px;left:483.0px;");
