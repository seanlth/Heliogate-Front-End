...
public class DocEditor extends CustomComponent {
	...
	@AutoGenerated
	private AbsoluteLayout top_area;
	@AutoGenerated
	...
	@AutoGenerated
	private AbsoluteLayout middle_area;
	@AutoGenerated
			...
			public void buttonClick(ClickEvent event) {
				...
				//	parameterTable.setVisible(true);
					...
					for (int i = 0; i < parameterFields.size(); i++) {
						middle_area.removeComponent(parameterFields.get(i));
					}
...
//							middle_area.addComponent(textField, "top:" + yPosition + "px;left:"+ xPosition  +"px");
...
//						}
		...
		runButton.addListener(new Button.ClickListener() {
			public void buttonClick(ClickEvent event) {
				...
				/*To be done, get all results and add them to the table. 
				 * See parameterTable listener for how to do it.
				 * 
				 * */
...
private void DeactivateEverythingPastStage2(){
	...
	private void DeactivateEverythingPastStage1(){
		...
		top_area.removeComponent(dateInputOne);
		top_area.removeComponent(dateInputTwo);
		...
		top_area.addComponent(dateInputOne, "top:86.0px;left:20.0px;");
		...
		top_area.addComponent(dateInputTwo, "top:126.0px;left:20.0px;");
	...
	private AbsoluteLayout buildAbsoluteLayout_2() {
		...
		// middle_area
		middle_area = buildmiddle_area();
		absoluteLayout_2.addComponent(middle_area,
				"top:273.0px;left:0.0px;");

		// top_area
		top_area = buildtop_area();
		absoluteLayout_2.addComponent(top_area, "top:13.0px;left:0.0px;");
	...
	@AutoGenerated
	private AbsoluteLayout buildmiddle_area() {
		// common part: create layout
		middle_area = new AbsoluteLayout();
		middle_area.setImmediate(false);
		middle_area.setWidth("880px");
		middle_area.setHeight("240px");
		middle_area.setMargin(false);
		...
		middle_area.addComponent(comboBox_5, "top:19.0px;left:260.0px;");
		...
		middle_area.addComponent(comboBox_4, "top:18.0px;left:20.0px;");
		...
		middle_area.addComponent(absoluteLayout_1,
		...
		middle_area.addComponent(setParametersButton,
		...
		middle_area.addComponent(parameterTable,
	...
	@AutoGenerated
	private AbsoluteLayout buildtop_area() {
		// common part: create layout
		top_area = new AbsoluteLayout();
		top_area.setImmediate(false);
		top_area.setWidth("880px");
		top_area.setHeight("260px");
		top_area.setMargin(false);
		...
		top_area.addComponent(setTimeButton, "top:86.0px;left:220.0px;");
		...
		top_area.addComponent(APMReadyButton, "top:7.0px;left:20.0px;");
		...
		findEventsComboBox.setInvalidAllowed(false);
		top_area.addComponent(findEventsComboBox,
		...
		top_area.addComponent(cataloguesComboBox,
		...
		top_area.addComponent(workflowComboBox,
		...
		top_area.addComponent(findEventsButton,
		...
		APMReadyStateLabel.setValue("Not Ready");
		top_area.addComponent(APMReadyStateLabel,
		...
		dateValidStateLabel.setValue("");
		top_area.addComponent(dateValidStateLabel,
		...
		top_area.addComponent(advancedUserButton,
		...
		top_area.addComponent(UserModalityLabel,
		...
		eventsLabel.setValue("");
		top_area.addComponent(eventsLabel,
	...
	private AbsoluteLayout buildAbsoluteLayout_3() {
		...
		runButton.setEnabled(false);
		runButton.setImmediate(true);
		runButton.setWidth("-1px");
		runButton.setHeight("-1px");
		absoluteLayout_3.addComponent(runButton, "top:86.0px;left:523.0px;");
		...
		resultsTable.setVisible(false);
		resultsTable.setWidth("728px");
		resultsTable.setHeight("175px");
		absoluteLayout_3.addComponent(resultsTable, "top:176.0px;left:60.0px;");
