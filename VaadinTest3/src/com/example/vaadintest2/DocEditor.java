...
public class DocEditor extends CustomComponent {
	...
	private ComboBox comboBox_5;
    	...
    	private String catalogueLocation = "/Users/seanlth/git/Heliogate-Front-End/Heliogate/catalogues.txt";
        ...
        public DocEditor() {
                ...
                //APMReadyTest.setIcon(new ThemeResource("/Users/seanlth/Documents/College Notes/Second Year/Software Engineering/button_orange.png"));
        }
		...
		private AbsoluteLayout buildAbsoluteLayout_2() {
			...
			absoluteLayout_2.addComponent(top_sean_area,
					"top:13.0px;left:0.0px;");
		...
		private AbsoluteLayout buildMiddle_tom_area() {
			...
			middle_tom_area
					.addComponent(comboBox_5, "top:19.0px;left:260.0px;");
		...
		private AbsoluteLayout buildTop_sean_area() {
			...
			top_sean_area.addComponent(setTimeButton,
					"top:86.0px;left:220.0px;");
			...
			top_sean_area
					.addComponent(dateInputTwo, "top:126.0px;left:20.0px;");
			...
			top_sean_area.addComponent(simpleUserButton,
					"top:47.0px;left:195.0px;");
		...
		private AbsoluteLayout buildAbsoluteLayout_3() {
			...
			absoluteLayout_3
					.addComponent(comboBox_7, "top:36.0px;left:20.0px;");
			...
			absoluteLayout_3.addComponent(comboBox_1,
					"top:36.0px;left:340.0px;");
			...
			absoluteLayout_3
					.addComponent(comboBox_8, "top:86.0px;left:20.0px;");
			...
			absoluteLayout_3.addComponent(comboBox_9,
					"top:86.0px;left:240.0px;");
			...
			absoluteLayout_3.addComponent(comboBox_10,
					"top:126.0px;left:240.0px;");
			...
			// runModel
			runModel = new Button();
			runModel.setCaption("Run !");
			runModel.setEnabled(false);
			runModel.setImmediate(true);
			runModel.setWidth("-1px");
			runModel.setHeight("-1px");
			absoluteLayout_3.addComponent(runModel, "top:86.0px;left:523.0px;");
